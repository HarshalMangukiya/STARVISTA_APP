...
const EditPropertyScreen = ({ route, navigation }: any) => {
  ...
  const handleUpdateProperty = async () => {
    ...
    try {
      ...
      let finalImageUrl: string | undefined = property.image_url;
      ...
      if (selectedImage && !selectedImage.isRemote) {
        ...
        if (property.image_url && property.image_url !== finalImageUrl) {
          deleteImageFromStorage(property.image_url).catch(console.warn);
        }
      }
